      ...
      <div id="About" className={AboutStyle.bigBox}>
        <div className={AboutStyle.white}>
          ...
          <p>
            ...
            Kven veit— kanskje eg til og med blir ein framtidig tilsett hjå
            dykk?
          </p>
          <br />
          <p>
            Eg har alltid hatt ein djup lidenskap for ulike former for kunst. På
            fritida liker eg å lage kostyme og å game. Desse hobbyane har lært
            meg verdifulle ferdigheiter, som presisjon, fokus på kvalitet,
